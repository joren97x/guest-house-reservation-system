        ...
        <div id="formContent">
            <div class="fadeIn first">
                <div class="row text-center">
                    <p class="h4 pt-3" ><i class="fa fa-address-card-o" aria-hidden="true"></i> Login </p>
                </div>
            </div>
            <div>
                ...
                <label class="mt-4">Dont have an account? </label>
                <a href="/register" class="text-primary mb-4"> Create Account</a>
            </div>
        </div>
      </form>
    </div>
